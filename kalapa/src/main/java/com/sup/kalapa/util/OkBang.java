...
public class OkBang {
    ...
    public static String get(String url) {
        return doHttp(url, null, null, null, null);
    }
    ...
    public static String get(String url, Map<String, String> params, Map<String, String> headers, String proxyHost, Integer proxyPort) {
    ...
    public static String postJson(String url, String json, String proxyHost, Integer proxyPort) {
        ...
        return doHttp(url, body, null, proxyHost, proxyPort);
    }
    ...
    public static String postForm(String url, Map<String, String> params, String proxyHost, Integer proxyPort) {
        ...
        return doHttp(url, builder.build(), null, proxyHost, proxyPort);
    }
    ...
    private static String doHttp(String url, RequestBody body, Map<String, String> headers, String proxyHost, Integer proxyPort) {
